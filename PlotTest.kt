...
class DifferentWays() {
    ...
    fun chooseYourWay() {
        println("1. Познакомиться с одиноким мальчиком")
        println("2. Познакомиться с хохочущей компанией")
        println("3. Ни с кем не знакомиться")
        val userInput = readLine()
        if (userInput != null) {
            if (userInput == "1") {
                println(
                    "- Привет! Ты тоже здесь впервый раз?\n" +
                            "- Привет. Да.\n" +
                ...
                val blueBranch = DayFirstBlueAndGreenChoice("В голове тут же возникла делема: стоит ли мне идти искать Эдуарда.", "Узнав о пропаже Эдуарда, я быстро собрал необходимые вещи (фонарик, нож, верёвку, дымовая шашка и бинты) и ускользнул в лес. Сердце сильно колотилось, я бы никогда не поступил бы так опраметчиво, пойдя в одиночку, но тогда думать было некогда.\n" +
                        ...
                        "Я собрался, обернулся… там был Вадик… Вадик? Что он там забыл, наверное, ищет Эдуарда, он же вожатый. Я хотел к нему подойти, но не стал, в конце концов я пропускаю завтрак. Доверя поиски Эдуарда Вадику, я отправился в корпус.", "Идти искать Эдуарда? Нет, это была бредовая идея. Я один ничего не смог бы сделать, поэтому поиски я доверил вожатым, в конце концов, вдруг это всё были слухи. Я умылся и пошёл на завтрак.")
                blueBranch.blueBranch()
                //сюда надо вставить синию ветку
            } else if (userInput == "2") {
                println(
                    "- Привет, ребят…\n" +
                ...
                println("Я долго не мог уснуть, но только около 2 часов ночи я начал проваливаться в сон, дверь в комнату приоткрылась, я услышал тихие шаги в свою сторону. Это был Вадик, он потряс меня за плечо и сказал: «Пошли, мне нужна твоя помощь». Я быстро собрался, хотя и не хотел куда-либо идти. Мы вышли из корпуса и молча пошли в сторону леса. Я пытался узнать, куда и зачем мы идём, но Вадик не был разговорчив, поэтому уже на 3 попытке я сдался. \n" +
                ...
                if (userInput != null) {
                    if (userInput == "1") {
                        println("Вадик повернулся ко мне, на его лице была странная тревожная улыбка: «Ничего страшного, у меня есть таблетки от головы…» С одной стороны он мой вожатый, но с другой стороны его кривая улыбка вызывала недоверие. Я не был уверен, стоит ли мне брать таблетку.")
                        println("1. Взять \n" +
                                "2. Не брать \n")
                        val userInput = readLine()
                        if (userInput != null) {
                            if (userInput == "1") {
                                println("Вадик протянул мне красную полупрозрачную таблетку, чем-то похожую на Нурофен, я успокоился и глотнул. Мы пошли дальше, но мне становилось только хуже, в глазах двоилось, шагать становилось тяжелее, я не мог даже звука… Дальше я помню только обрывками… топор в руках, крики детей, розовые нитки, боль в спине… \n" +
                                        "Я очнулся привязанным к дереву с кляпом во рту, всё тело ломило, как будто я пробежал кросс, я попробовал пошевелиться, ничего не вышло, руки скользили, они все были в какой-то склизской жидкости… это была кровь. Рядом сидел Вадик, он курил Chapman и продолжал мерзко улыбаться: «Спасибо, Август… В этот раз никто даже полицию не успел вызвать аахахаха, спасибо…» \n")
                            } else if (userInput == "2") {
                                println("Я отказался, но это не имело никакого смысла, ведь через мгновение он повалил меня на землю и сел сверху, левой рукой он схватил меня за руки, а правой запихивал мне в рот таблетку. Я пытался выплюнуть и закричать, но он закрыл мне рот рукой и начал смеяться. Дальше я помню только обрывками… топор в руках, крики детей, розовые нитки, боль в спине…\n" +
                                        "Я очнулся привязанным к дереву с кляпом во рту, всё тело ломило, как будто я пробежал кросс, я попробовал пошевелиться, ничего не вышло, руки скользили, они все были в какой-то склизской жидкости… это была кровь. Рядом сидел Вадик, он курил Chapman и продолжал мерзко улыбаться: «Спасибо, Август за помощь… Но ты тоже заставил меня попотеть ахах… Извини, конечно, но мне придётся попращаться и с тобой». Он достал топор и резко ударил чуть выше ключиц… А я… я и не пытался сопративляться, я уже не хотел жить… \n")
                            }
                    }
                    } else if (userInput == "2") {
                        println("Чем дальше мы заходили в лес, тем странее становилось поведенье Вадика. Он обкурился? Его предёргивало, он истерично посмеявился, потирал руки, постоянно облизывался… Я решил: надо бежать…")
                        println("но это не имело никакого смысла, ведь через мгновение он повалил меня на землю и сел сверху, левой рукой он схватил меня за руки, а правой запихивал мне в рот таблетку. Я пытался выплюнуть и закричать, но он закрыл мне рот рукой и начал смеяться. Дальше я помню только обрывками… топор в руках, крики детей, розовые нитки, боль в спине…\n" +
                                "Я очнулся привязанным к дереву с кляпом во рту, всё тело ломило, как будто я пробежал кросс, я попробовал пошевелиться, ничего не вышло, руки скользили, они все были в какой-то склизской жидкости… это была кровь. Рядом сидел Вадик, он курил Chapman и продолжал мерзко улыбаться: «Спасибо, Август за помощь… Но ты тоже заставил меня попотеть ахах… Извини, конечно, но мне придётся попращаться и с тобой». Он достал топор и резко ударил чуть выше ключиц… А я… я и не пытался сопративляться, я уже не хотел жить… ")
                    }
        }
...
class DayFirstBlueAndGreenChoice(option1: String, result1: String, result2: String) {
    ...
    fun blueBranch() {
        println(
            "Стоп… Что… Эдуард пропал?! В голове было столько мыслей, я не мог понять, как такое могло произойти, ведь он не их тех, кто любит доставлять неприятности. \n" +
    ...
    fun greenBranch() {
        println(
            "День был полон мероприятий и конкурсов, поэтому все утомились и уснули, только добравшись до кроватей. Но уже в 2 часа ночи мы стояли одетые на улице, усталость как рукой сняло, ведь нам предстояло пройти страшный квест в лесу, мы были в предкушении. Наш отряд вела Регина (Вадик скорее всего был где-то в лесу и готовился пугать нас), но как только за густыми деревьями скрылся главный корпус нашего лагеря, откуда-то сверху на нас спрыгнуло нечто горбатое в белой одежде, лица этого не было видно. Оно кричало и визжало, ужас охватил нас, у них получилось напугать нас, но это было только начало… Через мгновение это же горбатое существо прыгнуло на Регину и, закинув её на плечо, скрылось в лесу. Все были очень напуганы, но понимали, что это часть квеста, поэтому наш отряд быстро организовались и пошли на поиски Регины. Я шёл рядом с Хазилем и Мартой, когда заметил на ветке розовую паутинку.\n" +
        ...
        if (userInput != null) {
            if (userInput == "1") {
                println("Марта выхватыватила нож из кармана юбки, мы начинали распутывать Эдуарда. Но потратили на это слишком много времени, горбатый маньяк подбежал и со спины схватил Марту, нож выпал из её хрупких рук, на её лице читался только испуг, ни капли надежды на спасение. Ни я, ни Хазиль не могли пошевелиться, нас охватил ужас. Но тут Эдуард резким движением хватает нож с замли и бросается на горбатого, в этот же момент Марта кусает маньяка за руку, он выпускает её и тут же получает ножом в область живота. Хазиль хватает Марту за руку и убегает… Горбатый хватает за руку Эдуарда и ударяет по ней топором… руки как не бывало… я убежал…")
            } else if (userInput == "2") {
        ...
        if (userInput == "1") {
            ...
            if (userInput != null) {
                if (userInput == "1") {
                    ...
                    println("Я всё рассказал Регине, с её лица резко спала улыбка, я уточнил, всё ли хорошо, и она, уверив меня, что всё в порядке, пошла за телефоном. Уже к обеду в «Лесок» приехала полиция, они и нашли Эдуарда. Он был весь бледный (если быть ещё бледнее него вообще возможно) и ни с кем не разговаривал… А вечером за мной и другими ребятами приехали родители, они тоже ничего не сказали. По лагерю ходили слухи, что в лесу был маньяк, но я до сих пор не особо верю в эти слухи.")
                } else if (userInput == "2") {
